...
public class DayTest04 {
	public static void mian(String[] args) {
		Day day1 = new Day(2020, 8, 13); // 매개변수가 3개인 생성자
		Day day2 = new Day(day1); // 복사 생성자
		Day day3 = new Day(); // 기본 생성자
		Day day4 = new Day(2020); // 매개변수가 1개인 생성자
		Day day5 = new Day(2020, 8); // 매개변수가 2개인 생성자
		 
		System.out.println("day1 : " + day1); // toString 생략하면 자동 호출
